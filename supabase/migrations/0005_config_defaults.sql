...
values
  ...
  ('division', 'kFactorTitleMultiplier', '1.15'::jsonb, 'number', 'Title-fight K multiplier', 'Moderate extra weight for championship bouts (§14). Deliberately small.', 'Elo Core', 1, 2, 0.05, 2),
  ...
  ('division', 'titleWinBonus', '15'::jsonb, 'number', 'Title-fight win bonus', 'Moderate flat bonus for winning a championship bout (§14).', 'Method Bonus', 0, 60, 1, 17),
  ...
  ('division', 'streakBonusCap', '30'::jsonb, 'number', 'Streak bonus cap', 'Hard ceiling so streaks can never overpower opponent quality (§12).', 'Win Streak', 0, 120, 1, 32),
  ...
  ('division', 'autoRemoveInactive', 'false'::jsonb, 'boolean', 'Auto-remove inactive fighters', 'Off by default — inactive fighters stay ranked unless an admin removes them (§13).', 'Activity', null, null, null, 45),
  ...
  ('division', 'rankedPositions', '15'::jsonb, 'number', 'Ranked contender positions', 'Contenders shown beneath the champion (§16).', 'Table', 5, 30, 1, 50),
